...
export const SEED_DATA = {
  nl: {
    ...
    words: [
      { categoryId: 'nl-cat-breakfast', key: 'banana', article: 'de', word: 'banaan', placeholderEmoji: '🍌' },
      { categoryId: 'nl-cat-breakfast', key: 'milk', article: 'de', word: 'melk', placeholderEmoji: '🥛' },
      { categoryId: 'nl-cat-breakfast', key: 'bread', article: 'het', word: 'brood', placeholderEmoji: '🍞' },
      { categoryId: 'nl-cat-breakfast', key: 'spoon', article: 'de', word: 'lepel', placeholderEmoji: '🥄' },
      { categoryId: 'nl-cat-breakfast', key: 'cup', article: 'de', word: 'beker', placeholderEmoji: '🥤' },
      { categoryId: 'nl-cat-clothes', key: 'sock', article: 'de', word: 'sok', placeholderEmoji: '🧦' },
      { categoryId: 'nl-cat-clothes', key: 'shoe', article: 'de', word: 'schoen', placeholderEmoji: '👟' },
      { categoryId: 'nl-cat-clothes', key: 'coat', article: 'de', word: 'jas', placeholderEmoji: '🧥' },
      { categoryId: 'nl-cat-clothes', key: 'trousers', article: 'de', word: 'broek', placeholderEmoji: '👖' },
      { categoryId: 'nl-cat-toys', key: 'ball', article: 'de', word: 'bal', placeholderEmoji: '⚽' },
      { categoryId: 'nl-cat-toys', key: 'bear', article: 'de', word: 'beer', placeholderEmoji: '🧸' },
      { categoryId: 'nl-cat-toys', key: 'book', article: 'het', word: 'boek', placeholderEmoji: '📖' },
      { categoryId: 'nl-cat-toys', key: 'car', article: 'de', word: 'auto', placeholderEmoji: '🚗' },
    ],
  },
  pl: {
    ...
    words: [
      { categoryId: 'pl-cat-breakfast', key: 'banana', article: '', word: 'banan', placeholderEmoji: '🍌' },
      { categoryId: 'pl-cat-breakfast', key: 'milk', article: '', word: 'mleko', placeholderEmoji: '🥛' },
      { categoryId: 'pl-cat-breakfast', key: 'bread', article: '', word: 'chleb', placeholderEmoji: '🍞' },
      { categoryId: 'pl-cat-breakfast', key: 'spoon', article: '', word: 'łyżka', placeholderEmoji: '🥄' },
      { categoryId: 'pl-cat-breakfast', key: 'cup', article: '', word: 'kubek', placeholderEmoji: '🥤' },
      { categoryId: 'pl-cat-clothes', key: 'sock', article: '', word: 'skarpetka', placeholderEmoji: '🧦' },
      { categoryId: 'pl-cat-clothes', key: 'shoe', article: '', word: 'but', placeholderEmoji: '👟' },
      { categoryId: 'pl-cat-clothes', key: 'coat', article: '', word: 'kurtka', placeholderEmoji: '🧥' },
      { categoryId: 'pl-cat-clothes', key: 'trousers', article: '', word: 'spodnie', placeholderEmoji: '👖' },
      { categoryId: 'pl-cat-toys', key: 'ball', article: '', word: 'piłka', placeholderEmoji: '⚽' },
      { categoryId: 'pl-cat-toys', key: 'bear', article: '', word: 'miś', placeholderEmoji: '🧸' },
      { categoryId: 'pl-cat-toys', key: 'book', article: '', word: 'książka', placeholderEmoji: '📖' },
      { categoryId: 'pl-cat-toys', key: 'car', article: '', word: 'samochód', placeholderEmoji: '🚗' },
    ],
  },
};
