...
- **Verify changes by actually running the app**, not just syntax-checking: `.claude/skills/verify/SKILL.md` has the recipe (static server on :8321 + headless Chromium with a fake mic, plus the locator/dialog gotchas). Every feature v33–v36 was driven end-to-end this way before shipping.
